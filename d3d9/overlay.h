...
public:
	...
	int height;
	Color color;
	Font() :  color(green), times10(NULL), times24(NULL), helvetica10(NULL), helvetica12(NULL), helvetica18(NULL) {SetFontStyle(TimesNewRoman10);} 
	Font(FontStyle f, const Color& c) : color(c), times10(NULL), times24(NULL), helvetica10(NULL), helvetica12(NULL), helvetica18(NULL) {SetFontStyle(f);}
	Font(const Font& f) : color(f.color), times10(NULL), times24(NULL), helvetica10(NULL), helvetica12(NULL), helvetica18(NULL) {SetFontStyle(f.fontstyle);}
...
#else
	CD3DFont *times10, *times24, *helvetica10, *helvetica12, *helvetica18; ;
	CD3DFont* GetFontStyle() ;
#endif
};
...
public:
	...
	{
#ifndef _USING_OPENGL
		pD3Ddevice = (IDirect3DDevice9*)parg;
#endif
	}
	void OnViewport() {
		viewportcount++;
