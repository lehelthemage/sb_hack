...
{
	overlay::gui.Init(m_pD3Ddev);
	overlay::CTextBox* box = new overlay::CTextBox(0, 0, 100, 100, Font(Font::Helvetica10, Color(255, 255, 0)), "blah", Font(Font::Helvetica10, Color(255, 255, 0)), "hey wazzup", Color(255,255,255,255), Color(0,255,0, 40), Color(0,0,255, 200));
	overlay::gui.Add(box);
	D3DXCreateLine(m_pD3Ddev, &pLine);
	overlay::gui.Show(true);
	/*
...
{
	m_pD3Ddev->GetViewport(&oViewport);
